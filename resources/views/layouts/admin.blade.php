        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-50 shadow-md p-6 flex flex-col transform -translate-x-full transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 lg:flex-shrink-0 lg:h-full overflow-y-auto">
            ...
            <nav class="space-y-2 flex-grow">
                ...
                <div id="bookings-menu" class="hidden space-y-2 mt-2">
                    ...
                    <a href="{{ route('admin.availability.page') }}"
                        class="flex items-center px-4 py-3 ml-4 text-sm {{ request()->routeIs('admin.availability.page') ? 'text-[#0EA5E9] font-medium' : 'text-gray-700 hover:bg-gray-100' }} rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
