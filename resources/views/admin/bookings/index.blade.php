            ...
            <table class="w-full">
                <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                    <tr>
                        ...
                        <th class="text-left py-4 px-6 font-semibold text-gray-700 text-sm uppercase tracking-wider">Payment</th>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-4 px-6">
                                ...
                                @if($totalAmount > 0 && $totalPaid >= $totalAmount)
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-800">Full</span>
                                @elseif($totalPaid > 0)
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-orange-100 text-orange-800">Partial</span>
                                @else
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-600">Unpaid</span>
                                @endif
                            </td>
